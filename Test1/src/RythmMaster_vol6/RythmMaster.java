...
public class RythmMaster extends JFrame {
	...
	private ImageIcon startButtonEnteredImage = new ImageIcon(Main.class.getResource("../images/StartButtoncl.png"));
	private ImageIcon startButtonBasicImage = new ImageIcon(Main.class.getResource("../images/StartButton.png"));
	private ImageIcon quitButtonEnteredImage = new ImageIcon(Main.class.getResource("../images/ExitButtoncl.png"));
	...
	private ImageIcon easyButtonEnteredImage = new ImageIcon(Main.class.getResource("../images/easyButtoncl.png"));
	private ImageIcon easyButtonBasicImage = new ImageIcon(Main.class.getResource("../images/easyButton.png"));
	private ImageIcon hardButtonEnteredImage = new ImageIcon(Main.class.getResource("../images/hardButtoncl.png"));
	...
	public RythmMaster() {
		...
		trackList.add(new Track("TuboLifeTitle.jpg",
				"GameWall.jpg", "Tobu - Life.mp3", "Tobu - Life.mp3", "Tubo - Life"));
		trackList.add(new Track("JanjiHeroesTitle.jpg",
	...
	public void backMain() {
		...
		isGameScreen = false;
		game.close();
		RythmMaster.isGameOver = false; // 다시 초기화
	}
